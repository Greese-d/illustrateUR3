...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/masks', glob('masks/*.png')),
        ('share/' + package_name + '/emotions', glob('emotions/*.svg')),
        ('share/' + package_name + '/signature', glob('signature/*.svg')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'image_processing_node = portrait_vectorisation.image_processing_node:main',
        ],
    },
)